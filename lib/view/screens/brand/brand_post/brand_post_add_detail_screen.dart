...
import 'brand_edit_post_add_details_screen.dart';



class BrandPostAddDetailScreen extends StatelessWidget {
  const BrandPostAddDetailScreen({super.key});
      ...
      bottomNavigationBar: SafeArea(
        child: Padding(
          ...
          child: MyButton(onTap: () {
            Get.to(()=>BrandEditPostAddDetailsScreen());
          }, buttonText: "Post"),
        ),
      ),
      body: Padding(
